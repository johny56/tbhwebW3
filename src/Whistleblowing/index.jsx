import ConplaintForm from "./complaint_form";
...
executives of the activities&#39; results for acknowledgment.</p>
                ...
                <ConplaintForm></ConplaintForm>
                <div className="relative bottom-0 left-0 right-0 top-0 w-full overflow-hidden">
                <div className=" bg-scroll h-36 bg-[url(https://drive.google.com/uc?export=view&id=1VbqaCvp6OGGFT11eaatz_AqWai8yKYol)] bg-repeat z-10">

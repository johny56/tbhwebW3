            ...
            <div className="w-full bg-[#FFFFFF] shadow flex flex-col p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex flex-col text-start">
                        <h1 className=" text-6xl font-medium uppercase text-green-900 dark:text-neutral-50">
                            ACTIVITIES
                        </h1><br></br>
                        <p>Marketing posters for clients in the arts and culture industry, 2022</p>
                    </div>
                </div>

        ...
        <div>
            <div className="bg-cover bg-white h-full w-full pt-36">
                ...
                <div className="bg-white h-full w-2/3 ml-40 pt-8 pb-24">
                    ...
                    <p className="pt-4">The Department of Business Development, Ministry of Commerce on September 6th, 2023, conducted a ceremony to honor the 2023 recipients of the Given Award for Good Corporate Governance Standards.
...
among stakeholders. The Company is dedicated to upholding Good Corporate Governance and maintaining its values. As a result, the Company continues to expand and build a sustainable business as a component of Thailand’s overall economy.
                    ...
                    <p className="pt-4">เมื่อวันที่ 6 กันยายน 2566 ที่ผ่านมานี้ กรมพัฒนาธุรกิจการค้า กระทรวงพาณิชย์ ได้จัดพิธีเชิดชูเกียรติ ให้แก่ธุรกิจที่ผ่านการรับรองตามเกณฑ์มาตรฐานธรรมาภิบาลธุรกิจ ประจำปี 2566

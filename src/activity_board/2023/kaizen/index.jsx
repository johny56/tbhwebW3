        ...
        <div>
            <div className="bg-cover bg-white h-full w-full pt-36">
                ...
                <div className="grid grid-cols-3 gap-0 justify-center h-full w-5/6 ml-48 pt-12 md:pl-2 lg:pt-16">
                    ...
                    <div className="h-96 w-96">
                        <img src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/02-7.jpg?fit=1030%2C773&ssl=1"/>
                    </div>
                    <div className="h-96 w-96">
                        <img src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/03-7.jpg?fit=1030%2C772&ssl=1"/>
                    </div>
                    <div className="h-96 w-96">
                        <img src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/04-5.jpg?fit=1030%2C772&ssl=1"/>
                    </div>
                    <div className="h-96 w-96">
                        <img src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/08/5.png?fit=1030%2C773&ssl=1"/>
                    </div>
                    <div className="h-96 w-96">
                        <img src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/08/6.png?fit=1030%2C773&ssl=1"/>
                    </div>
                </div>

                <div className="bg-white h-full w-2/3 ml-40 pt-8 pb-24">

                <h2 className="text-bold text-2xl">TBH WON THAILAND KAIZEN GOLDEN AWARD 2023</h2>
                <h3 className="text-bold text-xl">On 11 August 2023 , Bangkok International Trade and Exhibition Centre</h3>
                <p className="pt-4">Mr. Somchai Manosathaporn and his team won the gold medal in the Automatic Kaizen category of the THAILAND KAIZEN AWARD 2023 competition organized by the Technology Promotion Association (Thai-Japanese) by presenting the work “Auto Feed Transverser” under the slogan “Kaizen Ideas, generates inventions, and promotes innovation.”

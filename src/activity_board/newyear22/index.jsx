                        ...
                        <div className="container mx-auto flex flex-col justify-center">
                            ...
                            <div className="flex flex-row">
                                ...
                                <div className="relative overflow-hidden hover:opacity-75 transition p-4">
                                    ...
                                    <img className="h-auto w-full rounded-lg" src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/01-4.jpg?fit=1030%2C686&ssl=1" alt=""/>
                                ...
                                <div className="relative w-auto h-auto overflow-hidden hover:opacity-75 transition p-4">
                                    <img className="h-auto w-full rounded-lg" src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/03-4.jpg?fit=1030%2C686&ssl=1" alt=""/>
                                </div>

                                <div className="relative w-auto h-auto overflow-hidden hover:opacity-75 transition p-4">
                                    <img className="h-auto w-full rounded-lg" src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/05-2.jpg?fit=1030%2C686&ssl=1" alt=""/>
                                </div>
                                <div className="relative overflow-hidden hover:opacity-75 transition p-4">
                                    
                                    <img className="h-auto w-full rounded-lg" src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/06-2.jpg?fit=1030%2C686&ssl=1" alt=""/>

                                </div>
                                <div className="relative overflow-hidden hover:opacity-75 transition p-4">
                                    
                                    <img className="h-auto w-full rounded-lg" src="https://i0.wp.com/www.teckbeehang.com/wp-content/uploads/2023/09/04-2.jpg?fit=1030%2C686&ssl=1" alt=""/>
                                </div>

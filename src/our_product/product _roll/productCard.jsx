...
//   return (
//     <div className="flex justify-center text-3xl md:text-7xl p-6 w-64 h-64 bg-slate-300 md:p-10 md:w-60 md:h-60 md:bg-green-300 items-center drop-shadow-md rounded-md">

//       <div onClick={handleClick} className="flex">
//         {!editable && <div className="opacity-800">{prop}</div>}
//         {editable && (
//           <input
